...
PUBLIC_KEYS = {
    ...
    "MAX_JOB_COST_USD", "ASR_BACKEND", "ASR_MODEL", "RENDER_PUNCH_IN", "LANGUAGE_POLICY", "DEFAULT_LAYOUT", "RENDER_UPSCALE", "ASR_MODEL_NON_ENGLISH", "MAX_SOURCE_HEIGHT", "YTDLP_COOKIES_FROM_BROWSER", "RENDER_WORKERS", "GOOGLE_CLIENT_ID",
}  # fmt: skip
